	...
	if (choice == 'links') {
			...
			if (left == 'langs') {
				...
				var naartoe = prompt ('Hij staat 300 meter verder dan waar je stond dus het is logisch dat je 2 rust pauzes nodig hebt. Als je voor hem staat vraagt hij \'welk getal is meer 1 of 0?\'');
					if (naartoe > '0') {
						...
						var nummer1 = prompt ('Je loopt er naartoe. Er staat op is het getal 10 kleiner dan het getal 5?.');
							if (nummer1 != 'ja') {
								...
								var woman = prompt ('Je loop weer een stuk verder je ziet een vrouw naar je toe lopen. Wat een lelijk ding is dat..... die pukkel op haar neus bedoel je natuurlijk. Ze heeft een peer in haar handen en ze vraagt of je hem zou willen?');
									if (woman === 'ja') {
		...
		var right = prompt ('Nadat je een stuk gelopen hebt zie je twee jochies voetballen. Je besluit om mee te doen, maar dan is het wel 1 tegen 2 natuurlijk. Wat verwacht je anders van van 2 jochies. Na een tijd voetballen sta je 1-3 achter. Hoeveel goals moet je nog maken om niet te verliezen?');
			if (right >= 2) {
				...
				var choice2 = prompt ('Je komt bij een spilisting. Je kan links af waar een klein eng meisje op de grond zit die je vol in je ogen aankijkt. Of je kan naar rechts waar je een bananen boom ziet staan. Welke kant ga je op?');
					if (choice2 !== 'rechts') {
						...
						var stress = prompt ('Er komt een heel gestreste mevrouw naar je toe rennen. Als ze eindelijk bij je is vraagt ze \'is het getal 8 minder dan het getal 14\'');
							if (stress == 'ja') {
								...
								var candy = prompt ('Een klein jochie met een lolly komt jou kant op gelopen. Je heb eigenlijk wel honger, maar je kan het niet maken om de lolly of te pakken toch?');
									if (candy == 'nee') {
										alert ('Hoe lekker de lolly er ook uiziet pak je hem niet af en loop je verder met een honerig gevoel.');
										var choice3 = prompt ('Je komt weer bij een spilisting. Je kan links of rechts waar ga je heen?');
											if (choice3 == 'links') {
